...
set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports {servo}];#Sch name = JB4
...
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports {echo}];#Sch name = JC9
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports {trigger}];#Sch name = JC10
