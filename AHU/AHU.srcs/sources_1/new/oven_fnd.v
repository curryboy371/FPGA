module oven_fnd(
    ...
    input tick,
    input toggle_1s,
    input [4:0] oven_state,
    input door_state,
    input [12:0] oven_time,
    output [7:0] seg,
    output [3:0] an
);
    ...
    wire [3:0] w_an_cycle;
    fnd_cycle #(.CYCLE_TICK_MS(100)) u_fnd_cycle1 (
        .clk(clk),
        .reset(reset),
        .tick(tick),
    ...
    wire [7:0] w_seg_data;
    wire [3:0] w_an_data;
    fnd_controller u_fnd_controller1(
        .clk(clk),
        .reset(reset),
        .input_data((oven_time / 60) * 100 + (oven_time % 60)),
        .seg_data(w_seg_data),
        .an(w_an_data)
    );
    ...
    fnd_controller_row u_fnd_controller_row1(
        .clk(clk),
        .reset(reset),
        .d1(r_d[0]),
        .d2(r_d[1]),
