...
module fnd_controller_row(
    ...
    fnd_display_row u_fnd_display_row(
        .digit_sel(w_sel),
        .d1(d1),
        .d10(d2),  
        .d100(d3),  
...
module fnd_display_row (
    ...
    always @(*) begin
        case(digit_sel)
            2'b00: begin seg = d1; an = 4'b1110; end
            2'b01: begin seg = d10; an = 4'b1101; end
            2'b10: begin seg = d100; an = 4'b1011; end
            2'b11: begin seg = d1000; an = 4'b0111; end
